### Erläuterung: Deklaration eines Arbeitsablaufs

An dieser Stelle ist _%[1]s_ ein Schlüsselwort, dass einen Arbeitsablauf bzw. Workflow einführt bzw. eindeutig
deklariert.
Wir definieren einen Arbeitsablauf wie folgt:

> Ein Arbeitsablauf ist eine detaillierte Beschreibung eines (Teil-)Geschäftsprozesses (business process) und zeigt die
> Schritte auf, die ein Akteur durchführen muss, um ein Geschäftsziel (business goal) zu erreichen.
